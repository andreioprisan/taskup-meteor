...
DUET.Project.prototype.prepViewProperties = function () {
    ...
    this.overdue = Math.abs(progressDifference);
    this.inProgress = Math.abs(100 - this.expectedProgress);
...
DUET.ProjectDetails.prototype.prepViewProperties = function () {
    ...
    this.overdue = this.project.expected_progress - this.project.progress;
    this.inProgress = Math.abs(100 - this.project.expected_progress);    
};
